...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.16, -- Basic efficiency for taxes without 'crats and tech
...
economy = {
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 0,	-- how fast pops are Hired when there is a medium demand

...
country = {
	...
	GREATNESS_DAYS = 1, 	   -- how many days until country risks losing status as great nation
	BADBOY_LIMIT = 25,
	...
	BASE_GREATPOWER_DAILY_INFLUENCE = 0, -- Influence value which is distributed each day
	...
	MIN_DELAY_BETWEEN_REFORMS = 36, -- months
...
military = {
	...
	NAVAL_LOW_SUPPLY_DAMAGE_PER_DAY = 4.9, -- damage to navies STR per day if totally 0% supplies (value from 0 to 100.0)
},
